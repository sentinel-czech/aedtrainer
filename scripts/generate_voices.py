...
CS = {
    ...
    "analyzing":       "Nestýkejte se pacienta. Analyzuji srdeční rytmus.",
    ...
    "reanalyze":       "Analyzuji srdeční rytmus. Nestýkejte se pacienta.",
    ...
    "pediatric_on":    "Dětský klíč vložen. Energie snížena na padesát joulů.",
}
